! function(n) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = n();
        ...
        var t;
        t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, t.leafletPip = n() } }(function() {
        ...
        function r(i, s) {
            if (!o[i]) {
                ...
                t[i][0].call(f.exports, function(n) {
                    var o = t[i][1][n];
                    return r(o ? o : n) }, f, f.exports, n, t, o, e) }
            return o[i].exports }
        for (var a = "function" == typeof require && require, i = 0; i < e.length; i++) r(e[i]);
        return r }({ 1: [function(n, t) {
            var o = n("geojson-utils"),
                e = { bassackwards: !1, pointInLayer: function(n, t, r) { "use strict";
                        n instanceof L.LatLng ? n = [n.lng, n.lat] : e.bassackwards && (n = n.concat().reverse());
                        var a = [];
                        return t.eachLayer(function(t) { r && a.length || (t instanceof L.Polygon) && o.pointInPolygon({ type: "Point", coordinates: n }, t.toGeoJSON().geometry) && a.push(t) }), a } };
            t.exports = e }, { "geojson-utils": 2 }], 2: [function(n, t) {! function() {
                function n(n) {
                    for (var t = [], o = [], e = 0; e < n[0].length; e++) t.push(n[0][e][1]), o.push(n[0][e][0]);
                    return t = t.sort(function(n, t) {
                        return n - t }), o = o.sort(function(n, t) {
                        return n - t }), [
                        [t[0], o[0]],
                ...
                function o(n, t, o) {
                    ...
                    return i }
                var e = this.gju = {}; "undefined" != typeof t && t.exports && (t.exports = e), e.lineStringsIntersect = function(n, t) {
                    for (var o = [], e = 0; e <= n.coordinates.length - 2; ++e)
                        for (var r = 0; r <= t.coordinates.length - 2; ++r) {
                            var a = { x: n.coordinates[e][1], y: n.coordinates[e][0] },
                                i = { x: n.coordinates[e + 1][1], y: n.coordinates[e + 1][0] },
                                s = { x: t.coordinates[r][1], y: t.coordinates[r][0] },
                                u = { x: t.coordinates[r + 1][1], y: t.coordinates[r + 1][0] },
                            ...
                            if (0 != h) {
                                var d = c / h,
                                    l = f / h;
                                d >= 0 && 1 >= d && l >= 0 && 1 >= l && o.push({ type: "Point", coordinates: [a.x + d * (i.x - a.x), a.y + d * (i.y - a.y)] }) } }
                    return 0 == o.length && (o = !1), o }, e.pointInBoundingBox = function(n, t) {
                    return !(n.coordinates[1] < t[0][0] || n.coordinates[1] > t[1][0] || n.coordinates[0] < t[0][1] || n.coordinates[0] > t[1][1]) }, e.pointInPolygon = function(t, r) {
                    ...
                    return u }, e.pointInMultiPolygon = function(t, r) {
                    ...
                    return s }, e.numberToRadius = function(n) {
                    return n * Math.PI / 180 }, e.numberToDegree = function(n) {
                    return 180 * n / Math.PI }, e.drawCircle = function(n, t, o) {
                    ...
                    return { type: "Polygon", coordinates: [s] } }, e.rectangleCentroid = function(n) {
                    var t = n.coordinates[0],
                        ...
                        i = r - o,
                        s = a - e;
                    return { type: "Point", coordinates: [o + i / 2, e + s / 2] } }, e.pointDistance = function(n, t) {
                    ...
                    return 6371 * f * 1e3 }, e.geometryWithinRadius = function(n, t, o) {
                    ...
                    return !0 }, e.area = function(n) {
                    for (var t, o, e = 0, r = n.coordinates[0], a = r.length - 1, i = 0; i < r.length; a = i++) {
                        var t = { x: r[i][1], y: r[i][0] },
                            o = { x: r[a][1], y: r[a][0] };
                        e += t.x * o.y, e -= t.y * o.x }
                    return e /= 2 }, e.centroid = function(n) {
                    for (var t, o, r, a = 0, i = 0, s = n.coordinates[0], u = s.length - 1, c = 0; c < s.length; u = c++) {
                        var o = { x: s[c][1], y: s[c][0] },
                            r = { x: s[u][1], y: s[u][0] };
                        t = o.x * r.y - r.x * o.y, a += (o.x + r.x) * t, i += (o.y + r.y) * t }
                    return t = 6 * e.area(n), { type: "Point", coordinates: [i / t, a / t] } }, e.simplify = function(n, t) { t = t || 20, n = n.map(function(n) {
                        return { lng: n.coordinates[0], lat: n.coordinates[1] } });
                    ...
                    for (o = n.length, h = 360 * t / (2 * Math.PI * 6378137), h *= h, r = 0, I[0] = 0, T[0] = o - 1, e = 1; e > 0;)
                        if (a = I[e - 1], i = T[e - 1], e--, i - a > 1) {
                            ...
                            h > f ? (m[r] = a, r++) : (e++, I[e - 1] = u, T[e - 1] = i, e++, I[e - 1] = a, T[e - 1] = u) } else m[r] = a, r++;
                    m[r] = o - 1, r++;
                    for (var w = new Array, s = 0; r > s; s++) w.push(n[m[s]]);
                    return w.map(function(n) {
                        return { type: "Point", coordinates: [n.lng, n.lat] } }) }, e.destinationPoint = function(n, t, o) { o /= 6371, t = e.numberToRadius(t);
